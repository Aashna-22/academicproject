			...
			<center><legend>Add New Book Details</legend></center>
				...
				<h4>Category</h4>
					...
					<p class="cd-select icon">
						<select class="b-category" name="b_category"  required>
	...
	<?php
		...
		if(isset($_POST['b_add']))
		{
			...
			else
			{
				...
				$query->bind_param("sssdds", $_POST['b_isbn'], $_POST['b_author'], $_POST['b_category'], $_POST['b_copies'], $_POST['b_price'], $_POST['b_title']);
